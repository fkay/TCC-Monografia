...
% ---
\titulo{Algoritmo Genético\\Um algoritmo evolucionário de busca e otimização}
...
% ponto e finalizadas também por ponto.
 ...
 \textbf{Palavras-chave}: Algoritmos Evolutivos. Algoritmo Genético. Otimização. Programação Orientada a Objetos.
\end{resumo}
...
\begin{resumo}[Abstract]
 \begin{otherlanguage*}{english}
   ...
   \noindent 
   \textbf{Keywords}: Evolutionary Algorithms. Genetic Algorithm. Optimization. Object Oriented Programming.
 \end{otherlanguage*}
\end{resumo}
