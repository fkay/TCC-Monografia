...
% Acerta o nome de listagens
\renewcommand{\lstlistingname}{Listagem}% Listing -> Algorithm
% parametros das listagens
\lstset{
	language={}, %% Troque para PHP, C, Java, etc... bash é o padrão
...
% evitar rodapé separar em páginas diferentes
...
\nocite{LeeJacobson2015, Melo2014, Grefenstette2012, ColinR.Reeves2002, Vose1999} % colocar nessa forma todos aqueles que não foram citados diretamente
\bibliography{TC}
