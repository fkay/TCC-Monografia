...
Devido a isso outros modelos foram propostos sobre os GA. Um deles feito por \citeauthor{Nix1992}, se baseia em um processo de cadeia de Markov, onde as populações definem os estados da cadeia, e os operadores atuando em conjunto definem a matriz de transição. Outro forma foi modelar o GA como um sistema dinâmico visto em \citeonline{Vose1991PunctuatedEI}.
